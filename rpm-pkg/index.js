...
var RpmpkgGenerator = module.exports = function RpmpkgGenerator(args, options) {
...
util.inherits(RpmpkgGenerator, yeoman.generators.Base);

RpmpkgGenerator.prototype.askFor = function askFor() {
    var cb = this.async();
